...
@section('content')
<h1>Editar vehículo: {{ $vehicle->placa }}</h1>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            ...
            <input type="text" name="placa" id="placa" class="form-control @error('placa') is-invalid @enderror"
                   value="{{ old('placa', $vehicle->placa) }}" maxlength="10" required>
    ...
    <div class="row mb-3">
        <div class="col-md-3">
            ...
            <input type="number" name="anio" id="anio" class="form-control @error('anio') is-invalid @enderror"
                   value="{{ old('anio', $vehicle->anio) }}" min="2000" max="{{ date('Y') + 1 }}" required>
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="capacidad" id="capacidad" class="form-control @error('capacidad') is-invalid @enderror"
                   value="{{ old('capacidad', $vehicle->capacidad) }}" min="1" max="99" required>
        ...
        <div class="col-md-3">
            ...
            <select name="estado" id="estado" class="form-select @error('estado') is-invalid @enderror" required>
                ...
                <option value="mantenimiento" {{ old('estado', $vehicle->estado) === 'mantenimiento' ? 'selected' : '' }}>Mantenimiento</option>
            </select>
        ...
        <div class="col-md-3">
            ...
            <select name="chofer_id" id="chofer_id" class="form-select @error('chofer_id') is-invalid @enderror">
                ...
                @foreach ($choferes as $chofer)
                    <option value="{{ $chofer->id }}" {{ old('chofer_id', $vehicle->chofer_id) == $chofer->id ? 'selected' : '' }}>
